...
const template = `
    ...
    <link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
          rel="stylesheet">
    <div class="${tw`flex fixed top-0 z-10 items-center px-3 w-full h-14 rounded-br-lg rounded-bl-lg bg-slate-200 font-body`}">
        <div class="${tw`container mx-auto`}">
            <a :href="href">
                <span class="${tw`text-lg font-bold`}">{{ title ?? "Assignment" }}</span>
            </a>
        </div>
    </div>
    <div class="${tw`mb-14`}"></div>
    <span class="text-red-500">auishdiahds</span>
`
...
export const Header = {
    ...
    props: ['title'],
    mounted() {
        this.$el.parentNode.adoptedStyleSheets = [sheet.target]
    },
    computed: {
        href: () => {
