    ...
    template: `
        <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md duration-200 ease-out dark:bg-gray-800 dark:border-gray-700 hover:scale-105">
            ...
            <div class="p-5">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 font-body">{{ description }}</p>
                <a :href="href"
                   class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 font-body"
               >
                    Learn more
                </a>
            </div>
